...
Section Test.
  ...
  Definition P : S -> bool := λ s, (eqS s aS).
  Definition uop_red : unary_op S := uop_predicate_reduce aS P.
  Definition bop_fpr_addS : binary_op S := bop_fpr aS P addS .
  Definition bop_fpr_mulS : binary_op S := bop_fpr aS P mulS .
  Lemma P_true : P aS = true. Proof. compute; auto. Qed.
