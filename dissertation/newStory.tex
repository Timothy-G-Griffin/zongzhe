...
\begin{itemize}
  \item $\forall a \in \mathbb{N}, min(0,n) = n = min(n,0)$ (0 is the annihilator for $min$)
...
\begin{itemize}
  \item additive component $min^r$ has the properties of selective, congruence, associative, commutative, has identity of 0, has annihilator of 0.
  \item multiplicative component $+^r$ has the properties of congruence, associative, commutative, has identity of $ceiling$, has annihilator of $ceiling$.
