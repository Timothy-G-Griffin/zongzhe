...
Lemma brel_reduce_congruence (S :Type) (eq : brel S) (r : unary_op S) : brel_congruence S eq eq -> brel_congruence S (brel_reduce r eq) (brel_reduce r eq).
Proof. intros H1 s1 s2 s3 s4. compute. intros H2 H3. apply (H1 (r s1) (r s2) (r s3)); auto. Qed.
...
; eqv_congruence     := brel_reduce_congruence S eq r (eqv_congruence S eq eqv)                                               
